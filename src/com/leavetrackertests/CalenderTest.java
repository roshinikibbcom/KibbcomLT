		...
		public void testLoginFunction() throws InterruptedException
		{
			...
			//Thread.sleep(1000);
			 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(8));
			  wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//*[contains(@content-desc, 'Calendar')]")));
			...
			WebElement sdateButton = driver.findElement(AppiumBy.xpath("//*[contains(@content-desc, 'Single')]"));
			sdateButton.click();
			
			//2025-03-26
			WebElement pickDate = driver.findElement(AppiumBy.xpath("//android.view.View[@text=\"2025-04-14\"]"));
			SingleTap(driver,pickDate);
			Thread.sleep(2000);
			//pickDate.click();
			//android.widget.Button[@content-desc="28, Friday, March 28, 2025"]
			WebElement selectDate = driver.findElement(AppiumBy.accessibilityId("21, Monday, April 21, 2025"));
			selectDate.click();
			Thread.sleep(2000);
